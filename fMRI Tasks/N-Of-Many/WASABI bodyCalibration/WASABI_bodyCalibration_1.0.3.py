...
for runs in runRange:
    ...
    bodyCalibration_bids=bodyCalibration_bids.append(showRatingScale(win, "ValenceRating", ValenceText, os.sep.join([stimuli_dir,"ratingscale","postvalenceScale.png"]), type="bipolar", biopacCode=valence_rating), ignore_index=True)
    ...
    bodyCalibration_bids=bodyCalibration_bids.append(showRatingScale(win, "RelaxationRating", RelaxText, os.sep.join([stimuli_dir,"ratingscale","RelaxScale.png"]), type="bipolar", biopacCode=relax_rating), ignore_index=True)
    bodyCalibration_bids=bodyCalibration_bids.append(showRatingScale(win, "AttentionRating", TaskAttentionText, os.sep.join([stimuli_dir,"ratingscale","TaskAttentionScale.png"]), type="bipolar", biopacCode=taskattention_rating), ignore_index=True)
    bodyCalibration_bids=bodyCalibration_bids.append(showRatingScale(win, "BoredomRating", BoredomText, os.sep.join([stimuli_dir,"ratingscale","BoredomScale.png"]), type="bipolar", biopacCode=boredom_rating), ignore_index=True)
