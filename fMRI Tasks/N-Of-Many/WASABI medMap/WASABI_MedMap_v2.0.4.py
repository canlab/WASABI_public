...
for runs in runRange:
    ...
    if runs==6:
        ...
        # Changes in 2.0.4: Increase uncertainty from ses-02 by setting all trials to HighHeat-1 instead of HighHeat.
        elif expInfo['second(2) or third(3) day']=='3':
            if runs in [0, 1, 6, 7]:
                ConditionName="Control"
            if runs in [2, 3, 4 ,5]:
                ConditionName="Placebo"
            temperature = participant_settingsHeat[bodySites[runs]]-1 # 2.0.4 Revision 1/15/2023. Temperature-1.
            thermodeCommand=thermode_temp2program[temperature]
