...
#SBATCH -o SID000002/fmriprep_%j.txt
#SBATCH -e SID000002/fmriprep_%j.err
#SBATCH --nodes=1
...
SESSION=(ses-01 ses-03 ses-06 ses-07 ses-08 ses-09 ses-10 ses-11 ses-12 ses-13 ses-14 ses-15 ses-16 ses-17 ses-18 ses-19 ses-20 ses-21)
