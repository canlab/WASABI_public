...
#SBATCH --job-name=[fmriprep_wasabi_SID001567]
#SBATCH -o SID001567/filename_%j.txt
#SBATCH -e SID001567/filename_%j.err
#SBATCH --nodes=1
...
SESSION=(ses-01 ses-02 ses-03 ses-04 ses-05 ses-06 ses-07 ses-08 ses-09 ses-10 ses-11 ses-12 ses-13 ses-14 ses-15 ses-16 ses-17 ses-18 ses-19 ses-20)
