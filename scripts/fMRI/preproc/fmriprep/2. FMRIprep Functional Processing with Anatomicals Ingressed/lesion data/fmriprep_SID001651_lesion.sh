...
#SBATCH --job-name=[fmriprep_wasabi_SID001651]
#SBATCH -o SID001651/filename_%j.txt
#SBATCH -e SID001651/filename_%j.err
#SBATCH --nodes=1
...
SESSION=(ses-01 ses-02 ses-03 ses-04 ses-05 ses-06 ses-07 ses-09 ses-10 ses-11 ses-12 ses-14 ses-15 ses-16 ses-18 ses-19 ses-20 ses-24)
...
BIDSDIR=${MAINDIR}/1080_wasabi.lesion
