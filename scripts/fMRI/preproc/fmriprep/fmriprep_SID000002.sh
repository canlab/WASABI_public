...
#SBATCH --job-name=[fmriprep_wasabi_SID000002]
#SBATCH -o SID000002/filename_%j.txt
#SBATCH -e SID000002/filename_%j.err
#SBATCH --nodes=1
...
# FILTERS=(filter-01 filter-02 remaining)
...
IMAGE=/dartfs-hpc/rc/lab/C/CANlab/modules/fmriprep_23.0.0.sif
