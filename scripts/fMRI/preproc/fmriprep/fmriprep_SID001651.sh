...
# FILTERS=(filter-01 filter-02 filter-03 filter-04 filter-05 filter-06 filter-07 filter-08 filter-09 filter-10 remaining)
...
# --bids-filter-file ${FILTER_DIR}/${SUBJ}_${FILT}.json
