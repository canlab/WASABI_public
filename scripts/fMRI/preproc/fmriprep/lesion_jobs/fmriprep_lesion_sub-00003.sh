...
#SBATCH --job-name=[prep_sub-00003]
#SBATCH -o lesion/sub-00003/filename_%j.txt
#SBATCH -e lesion/sub-00003/filename_%j.err
#SBATCH --nodes=1
...
DATASET=(1080_wasabi.sub-00003_set-01 1080_wasabi.sub-00003_set-02 1080_wasabi.sub-00003_set-03 1080_wasabi.sub-00003_set-04 1080_wasabi.sub-00003_set-05)
