...
#SBATCH --job-name=[prep_sub-00005]
#SBATCH -o lesion/sub-00005/filename_%j.txt
#SBATCH -e lesion/sub-00005/filename_%j.err
#SBATCH --nodes=1
...
DATASET=(1080_wasabi.sub-00005_set-01 1080_wasabi.sub-00005_set-02)
