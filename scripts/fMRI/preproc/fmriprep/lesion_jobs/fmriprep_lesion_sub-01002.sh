...
#SBATCH --job-name=[prep_sub-01002]
#SBATCH -o lesion/sub-01002/filename_%j.txt
#SBATCH -e lesion/sub-01002/filename_%j.err
#SBATCH --nodes=1
...
DATASET=(1080_wasabi.sub-01002_set-01)
...
BIDSDIR=${MAINDIR}/lesion-datasets/${DATASET[0]}
OUTDIR=${MAINDIR}/derivatives/fmriprep/lesion/${DATASET[0]}
mkdir -p ${OUTDIR}
# WORKDIR=${OUTDIR}/work/work-${SUBJECTS}
# PREPROCDIR=$(readlink -f ${MAINDIR}/preproc)
SCRATCHDIR=/dartfs-hpc/scratch/$USER
WORKDIR=${SCRATCHDIR}/fmriprep-work/work-${SUBJECTS}/${DATASET[0]}
